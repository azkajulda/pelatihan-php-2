          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="form-group @error('nim') has-error @enderror col-md-8">
                ...
                <input type="number" name="nim" class="form-control" id="nim" placeholder="Nomor Induk Mahasiswa" required>
                @error('nim')
              ...
              <div class="form-group @error('nama') has-error @enderror col-md-8">
                ...
                <input type="text" name="nama" class="form-control" id="namaMahasiswa" placeholder="Nama Mahasiswa" required>
                @error('nama')
                  <span class="help-block">{{$message}}</span>
                @enderror
              </div>
              ...
              <div class="form-group @error('kelas') has-error @enderror col-md-8">
                ...
                <select class="form-control" name="kelas" id="kelas" required>
                  ...
                  <option value="SI-40-01">SI-40-01</option>
                  <option value="SI-40-02">SI-40-02</option>
                  <option value="SI-40-03">SI-40-03</option>
                </select>
                @error('kelas')
                  <span class="help-block">{{$message}}</span>
                @enderror
